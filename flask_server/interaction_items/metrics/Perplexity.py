...
class Perplexity(MetricItem):
    ...
    # From https://github.com/WanliYoung/Collapse-in-Model-Editing/blob/main/ppl.py
    def compute(self, predictions, model, tokenizer, batch_size: int = 16, add_start_token: bool = True, device=None,
                max_length=None):
        ...
        for start_index in range(0, len(encoded_texts), batch_size):
            ...
            shift_logits = out_logits[..., :-1, :].contiguous().to(dtype=torch.float32)
    ...
    def get_text_outputs(self, prompt: str, token_logits: torch.Tensor, pre_hook_rv=None, **kwargs):
        text_samples = self.config.dataset
